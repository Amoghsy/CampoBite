...
public class EmailService {
    ...
    @Async
    public void sendSignupOtpEmail(String toEmail, String name, String otp) {
        try {
            jakarta.mail.internet.MimeMessage message = mailSender.createMimeMessage();
            org.springframework.mail.javamail.MimeMessageHelper helper = new org.springframework.mail.javamail.MimeMessageHelper(
                    message, true, "UTF-8");
            ...
            helper.setTo(toEmail);
            helper.setFrom("amoghsys891@gmail.com");
            helper.setSubject("✉️ Verify Your Email - CampoBite");
                    ...
                    <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; background-color: #f4f6f8;">
                        <div style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
                            <div style="background: linear-gradient(135deg, #27b08b 0%%, #13907b 100%%); padding: 30px 20px; text-align: center; color: white;">
                                ...
                                <p style="margin: 5px 0 0; font-size: 14px; opacity: 0.9;">CampoBite Account Registration</p>
                            </div>
                            <div style="padding: 30px; text-align: center;">
                                <p>Hi <strong>%s</strong>,</p>
                                <p style="color: #666;">Use the OTP below to complete your account registration.</p>

                                <div style="background-color: #eafcf6; border: 1px solid #c9eee5; border-radius: 12px; padding: 20px; margin: 25px 0;">
                                    <h2 style="margin: 0; color: #13907b; font-size: 14px; text-transform: uppercase;">Your Verification Code</h2>
                                    <h1 style="margin: 10px 0; color: #27b08b; font-size: 48px; letter-spacing: 8px; font-weight: 800;">%s</h1>
                                    <p style="margin: 0; font-size: 12px; color: #cc5555;">Valid for 5 minutes only</p>
                                </div>
    ...
    public void sendPasswordResetOtpEmail(String toEmail, String otp) {
        try {
            ...
            helper.setTo(toEmail);
            helper.setFrom("amoghsys891@gmail.com");
            helper.setSubject("🔑 Reset Your Password - CampoBite");

            String htmlContent = """
                    <html>
                    <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; background-color: #f4f6f8;">
                        <div style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
                            <div style="background: linear-gradient(135deg, #e74c3c 0%%, #c0392b 100%%); padding: 30px 20px; text-align: center; color: white;">
                                <h1 style="margin: 0; font-size: 24px;">Password Reset</h1>
                                <p style="margin: 5px 0 0; font-size: 14px; opacity: 0.9;">CampoBite Account</p>
                            </div>
                            <div style="padding: 30px; text-align: center;">
                                <p>Hello,</p>
                                ...
                                <div style="background-color: #fef2f2; border: 1px solid #fecaca; border-radius: 12px; padding: 20px; margin: 25px 0;">
                                    <h2 style="margin: 0; color: #dc2626; font-size: 14px; text-transform: uppercase;">Your Reset Code</h2>
                                    <h1 style="margin: 10px 0; color: #e74c3c; font-size: 48px; letter-spacing: 8px; font-weight: 800;">%s</h1>
                                    <p style="margin: 0; font-size: 12px; color: #cc5555;">Valid for 5 minutes only</p>
                                </div>
